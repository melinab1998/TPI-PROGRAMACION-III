...
export const updateUserRole = async (req, res) => {
    try {
        ...
        return res.status(200).json({ message: "Rol del usuario actualizado correctamente", user });
    } catch (error) {
        console.error("Error al actualizar el rol del usuario:", error);
        return res.status(500).json({ message: "Error interno al actualizar el rol del usuario" });
    }
};
...
export const getUsers = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Error interno al obtener los usuarios" });
    }
};