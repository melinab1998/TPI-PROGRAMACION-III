...
export const  createShelter = async (req, res) => {
    ...
    try {
      ...
      if ([name, address, phone, email].some(campo => campo === undefined || campo === null)) {
      ...
      return res.status(201).json({ message: "Refugio creado exitosamente.", newShelter });
    } catch (error) {
    ...
    export const updateShelter = async(req, res) =>{
      try{
        ...
        if(!shelter){
          return res.status(404).json({ message: "Ocurrió un error al obtener el refugio." });
      }
        ...
        return res.status(200).json({ message: "Refugio actualizado exitosamente.", shelter });
    ...
    export const deleteShelter = async(req, res) =>{
      ...
      try{
        ...
        return res.status(200).json({ message: "Refugio eliminado exitosamente.", shelter });
